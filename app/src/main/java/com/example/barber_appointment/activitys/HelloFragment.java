...
//        String email= args.getEmail();
        ...
        if ((conectedUser.getNextTor().getPurpose()!= "No Appointment exsist") && (l1.isAfter(LocalDateTime.now()))) {
            ...
            nDate.setText(" -- ");
            nTime.setText(" -- ");
            nPurpos.setText("No Appointment exist");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cancelApBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((conectedUser.getNextTor().getPurpose()== "No Appointment exist") || conectedUser.getNextTor().getDate().isBefore(LocalDate.now())) {
                    Toast.makeText(v.getContext(),"No Appointment exist to cancel", Toast.LENGTH_LONG).show();
                }
                else{
        ...
        Button logout_but= view.findViewById(R.id.logOutBut_HelloPage);
