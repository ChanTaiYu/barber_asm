package com.example.barber_appointment.activitys;

import static com.example.barber_appointment.addapters.MyData.dataSetUsres;
import static com.example.barber_appointment.addapters.MyData.dateSelected;
import static com.example.barber_appointment.addapters.MyData.timeSelected;
import static com.example.barber_appointment.addapters.MyData.torList;
...
import com.example.barber_appointment.R;
import com.example.barber_appointment.addapters.CustomAdapter;
import com.example.barber_appointment.addapters.MyData;
import com.example.barber_appointment.myThreads.LoadTorsThread;
import com.example.barber_appointment.services.Tor;
import com.example.barber_appointment.services.User;
        ...
        cancelBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((!torList[hour-8].getNameOf().equals("Avilable"))&&(!torList[hour-8].getNameOf().equals("Not-Avilable"))){
                    torList[hour-8].setNameOf("Available");
        ...
        notAvilBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (torList[hour-8].getNameOf().equals("Avilable")){
                    torList[hour-8].setNameOf("Not-Available");
                    torList[hour-8].setPurpose("--");
                    MainActivity mainActivity= (MainActivity) getActivity();
                    mainActivity.writeDataDao("Not-Avilable","*00",dateSelected,torList[hour-8].getStartTime(),torList[hour-8].getEndTime(),"--");
                    Toast.makeText(v.getContext(),"Marked as not available ", Toast.LENGTH_LONG).show();
                    recycleAction(view);
                    v.refreshDrawableState();
                }
            }
            ...
            public void onClick(View v) {
                ...
                for (int i=0;i<10;i++) {
                    if (torList[i].getNameOf().equals("Avilable")) {
                        torList[i].setNameOf("Not-Available");
